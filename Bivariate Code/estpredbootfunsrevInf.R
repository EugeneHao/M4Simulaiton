...
predictMCM1Inf <- function(data1, param, paraminf, Sigma_est, fitteddata, data, Msamps){
        ...
        YZgen <- replicate(Msamps, SimulateYZ(data, randMC, paraminf[c(1,2)], paraminf[c(3,4)], param[5], param[6], probImp, D))
...
predictMCM1InfLS <- function(data1, param, paraminf, Sigma_est, fitteddata, data, Msamps, Lsamps){
        ...
        YZgen <- sapply(1:Lsamps, SimulateYZL, data, randMC, paraminf[c(1,2)], paraminf[c(3,4)], param[5], param[6], probImp, D, Lsamps, Msamps)
